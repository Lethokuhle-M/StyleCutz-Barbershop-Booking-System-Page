        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (FileUpload1.HasFile)
            {
                try
                {
                    ...
                    string fileName = serviceName +".jpg"; // Add timestamp
                    ...
                    string message = "Select Products the Service Uses";
                    string url = "/Private/Admin/ServiceLink"; // Replace with your target page URL
