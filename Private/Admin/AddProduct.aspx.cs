...
namespace StyleCutzBarberShopWebApp.Private.Admin
{
    public partial class AddProduct : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            string imagePath = Server.MapPath("~/ImageProducts"); // Ensure the path is correct
            ...
            System.Diagnostics.Debug.WriteLine("File selected: " + FileUpload1.HasFile);
            ...
            if (FileUpload1.HasFile)
            {
                try
                {
                    ...
                    string fileName = ProductName + ".jpg"; // Add timestamp
            ...
            {
                string message = "Select the supplier of the product  First!!!";
                string script = $"<script type='text/javascript'>alert('{message}');</script>";
                ClientScript.RegisterStartupScript(this.GetType(), "alert", script);
