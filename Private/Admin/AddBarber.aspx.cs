...
{
    public partial class AddBarber : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            string barberName = TextBox2.Text;
            ...
            if (FileUpload1.HasFile)
            {
                try
                {
                    ...
                    string fileName = barberName + ".jpg"; // Add timestamp
                    ...
                    string errorMessage = "Emplyee added successfully" ;
