<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MakeOrderPayment.aspx.cs" Inherits="StyleCutzBarberShopWebApp.Private.Manager.MakeOrderPayment" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="grid-container">
        ...
        <div>
            <label class="label" style="color:black">Amount Owing:</label>
            <asp:TextBox ID="TextBox1" runat="server" CssClass="text-box"></asp:TextBox>
            <label class="label "style="color:black">Payment Amount:</label>
            <asp:TextBox ID="TextBox2" runat="server" CssClass="text-box"></asp:TextBox>
            <asp:Button ID="Button1" runat="server" OnClientClick="return Confirm();" OnClick="Button1_Click" Text="Make Payment" CssClass="button" />
        </div>
    </div>
    <script>
        function Confirm() {
            if (confirm("Are you sure you want to Make Order Payment?") == true)
                return true;
            else
                return false;
        }
