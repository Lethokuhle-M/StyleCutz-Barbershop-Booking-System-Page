<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProductSupplier.aspx.cs" Inherits="StyleCutzBarberShopWebApp.Private.Manager.ProductSupplier" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="gridview-container">
     ...
     <asp:Button ID="btn1" runat="server" style="margin-left:45%;width:fit-content" CssClass="btn" OnClick="btn1_Click" Text="Next" Width="150px" />
