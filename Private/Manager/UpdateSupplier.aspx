<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateSupplier.aspx.cs" Inherits="StyleCutzBarberShopWebApp.Private.Manager.UpdateSupplier" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="gridview-container">
        <asp:GridView ID="GridView1" ToolTip="First Click Edit,Then Enter Values In The Colomn" runat="server" CssClass="gridview gridview-spacing" AutoGenerateColumns="False" DataSourceID="SqlDataSource1"  style="margin-right: 0" Width="1135px" AllowPaging="True" >
            <Columns>
